...
const Create = ({ marketplace, nft }) => {
  ...
  const sendJSONtoIPFS = async (ImgHash) => {
    ...
    try {
      ...
      const resJSON = await axios({
        ...
        headers: {
          'pinata_api_key': "a16e64be5d1e38a0b43d",
          'pinata_secret_api_key': "00dc4bfd54c077da8534c5382e58478ed457ab904e7695c34385df5955f38143",
  ...
  const sendFileToIPFS = async (e) => {
    ...
    e.preventDefault();
    console.log("a16e64be5d1e38a0b43d");
    console.log(e);
